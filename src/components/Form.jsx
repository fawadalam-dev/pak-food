        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-0 rounded-2xl bg-gray-800 border-3 border-orange-500 overflow-hidden shadow-2xl">
            <input
              ...
              value={usermeal}
            />
            <button type="submit" disabled={loading} className="px-10 py-4 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-500 text-white font-bold text-lg transition duration-200">
